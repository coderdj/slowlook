...
Template.body.addContent((function() {
  ...
  })), "\n      ", HTML.Raw('<div class="col-xs-3"><button class="btn btn-info" id="refresh">Refresh Plots</button></div>'), "\n    "), "\n    ", HTML.DIV({
    "class": "row"
  }, "\n      ", HTML.DIV({
  ...
  }), "\n	"), "      \n      "), "\n\n", HTML.Raw('<!--      <div class="col-md-8 col-sm-8 col-xs-12">\n	{{> plot_0}}\n      </div>-->'), "\n    "), "\n  ") ];
}));
...
Template["text"] = new Template("Template.text", (function() {
  ...
  return HTML.DIV({
    ...
    "class": "col-xs-6"
  }, "\n	", HTML.H5(HTML.STRONG(Blaze.View("lookup:name", function() {
    return Spacebars.mustache(view.lookup("name"));
  }), ":", HTML.Raw("&nbsp;"))), "\n      "), "\n      ", HTML.DIV({
    "class": "col-xs-6"
  }, "\n	", HTML.H5(Blaze.View("lookup:value", function() {
